...
import { Calendar, Download, Send, Users, X, Check, Copy, Mail, ChevronLeft, Smartphone } from "lucide-react";
                    ...
                    {isMobile ? (
                      <>
                        ...
                        {mobileOS === 'ios' && (
                          ...
                          >
                            <div className="w-10 h-10 bg-linear-to-br from-pink-500 via-red-500 to-orange-500 rounded-xl flex items-center justify-center">
